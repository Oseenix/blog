...
## 5. The Architecture: Triple-Nested asyncio.run()
...
## 8. A Third Uncapped `asyncio.run()`, Hidden Behind Dead Code
...
### 10.1 run_capped(): Cap the Executor
...
### 10.2 Await Fire-and-Forget Tasks
...
### 10.3 Cap the Executor in noaa.py (and Delete the Dead Code Hiding It)
...
### 10.4 Suppress OpenBLAS Thread Pool
...
## 13. Why the Reproducers Didn't Leak
...
## 15. Part 2: Threads Fixed, RSS Still Growing
...
## 16. /proc/smaps: Where the Memory Actually Lives
...
## 17. glibc Arenas: The Invisible Memory Pool
...
### 17.3 Thread-to-Arena Assignment
...
### 17.4 Why free() Doesn't Return Memory
...
## 19. The Fix: Two Lines

### 19.1 Cap Arena Count
...
## 20. Why Not Just malloc_trim Without MALLOC_ARENA_MAX?
...
## 22. Part 3: When os.environ Is Too Late
...
### 22.1 glibc Reads the Environment Once
...
### 22.2 Setting the Environment Before the Process
